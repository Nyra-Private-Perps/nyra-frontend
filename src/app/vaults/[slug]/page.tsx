...
export default async function VaultPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-purple-950 via-black to-cyan-950" />
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,rgba(139,92,246,0.15),transparent_70%)] animate-pulse" />
